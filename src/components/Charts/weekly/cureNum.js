...
class WeeklyCureNum extends React.Component {

    componentDidMount() {

        var id;
        // 初始化
        let myChart = echarts.init(document.getElementById('WeeklyCureNum'));
    ...
    render() {
        return (
            <div id="WeeklyCureNum" style={{width: '100%', height: 340}}/>
        );
    }
}

export default WeeklyCureNum;